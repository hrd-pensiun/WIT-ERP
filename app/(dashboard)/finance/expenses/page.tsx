    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Kelola data pengeluaran</p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          {loading ? (
            ...
            <div className="text-center py-10 text-muted-foreground">Belum ada pengeluaran</div>
          ) : (
              ...
              {expenses.map((expense) => (
                <div key={expense.id} className="flex items-center justify-between rounded-lg border border-border bg-background p-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge className="bg-muted text-foreground">{expense.category}</Badge>
                    ...
                    <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-red-400" onClick={() => handleDelete(expense.id)}>
