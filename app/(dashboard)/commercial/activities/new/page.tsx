...
export default function NewActivityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/commercial/activities")
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/commercial/activities"><Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground"><ArrowLeft className="w-5 h-5" /></Button></Link>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-3 pt-6 border-t border-border">
              <Link href="/commercial/activities"><Button type="button" variant="ghost" className="text-muted-foreground">Batal</Button></Link>
