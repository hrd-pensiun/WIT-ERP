    ...
    return (
      <div>
        <div className="text-center py-12">
          ...
          <Link href="/commercial/leads"><Button variant="outline" className="mt-4 border-border">Kembali</Button></Link>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/commercial/leads"><Button variant="ghost" size="icon"><ArrowLeft className="w-5 h-5" /></Button></Link>
        <div>
