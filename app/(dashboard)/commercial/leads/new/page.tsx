  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createLead({
        ...
        estimated_value: formData.estimated_value ? parseFloat(formData.estimated_value.replace(/[^0-9.]/g, "")) || null : null,
            ...
            <Card>
              <CardContent className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  {/* Estimasi Nilai */}
                  <div className="space-y-2">
                    <Label className="text-sm font-medium">Estimasi Nilai (Rp)</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs text-zinc-400 font-medium">Rp</span>
                      <Input
                        type="text"
                        value={formData.estimated_value}
                        onChange={(e) => setFormData({ ...formData, estimated_value: e.target.value, budget_value: e.target.value })}
                        placeholder="Nilai estimasi proyek..."
